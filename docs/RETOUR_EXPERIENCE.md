...
horodatage sur `__HOST_ADMIN__`. Mémoire procédurale lue avant exécution :
...
**Constat** : L'opérateur demande la suppression d'un clone identifié par sa date
...
horodaté (`__HOST_ADMIN__-2026-05-29-09-20-02`), exposé tel quel dans
