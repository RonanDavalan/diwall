...
`__HOST_ADMIN__` (DOM uniquement). Aucune soumission serveur : validation HTML5
...
{"type": "remplir", "selecteur": "input[name=\"password\"]",    "valeur": "__PASSWORD_FACTICE__"},
...
**Contexte** : chantier 3 Sillage — push __DOMAINE_CLIENT__ __HOST_ADMIN__→__HOST_VPS__ via connexion internet.
