...
```
/opt/diwall/venv/bin/python3 /home/<user>/git/Diwall/_CADRE/scripts/search-index.py "..."
```
...
```
~/.pyenv/versions/3.12.11/bin/python3 /home/<user>/git/Diwall/_CADRE/scripts/search-index.py "..."
```
